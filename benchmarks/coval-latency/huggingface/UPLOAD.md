# Prepared Hugging Face dataset update

Target dataset: `AirCaps/a5sv2-asr-benchmark-dataset`
...
Hugging Face web interface or `hf upload`; do not replace the dataset's root card. Append
`DATASET_CARD_SECTION.md` to the existing card and keep the file mapping unchanged so the hashes
remain auditable.
